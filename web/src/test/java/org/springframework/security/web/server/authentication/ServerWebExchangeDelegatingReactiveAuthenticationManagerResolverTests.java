...
public class ServerWebExchangeDelegatingReactiveAuthenticationManagerResolverTests {
	...
	public void resolveWhenMatchesThenReturnsReactiveAuthenticationManager() {
		// @formatter:off
		ServerWebExchangeDelegatingReactiveAuthenticationManagerResolver resolver =
				ServerWebExchangeDelegatingReactiveAuthenticationManagerResolver.builder()
						.add(new ServerWebExchangeMatcherEntry<>(ServerWebExchangeMatchers.pathMatchers("/one/**"), this.one))
						.add(new ServerWebExchangeMatcherEntry<>(ServerWebExchangeMatchers.pathMatchers("/two/**"), this.two))
						.build();
		// @formatter:on
