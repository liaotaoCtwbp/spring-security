...
public class RequestMatcherDelegatingAuthenticationManagerResolverTests {
	...
	public void resolveWhenMatchesThenReturnsAuthenticationManager() {
		// @formatter:off
		RequestMatcherDelegatingAuthenticationManagerResolver resolver =
				RequestMatcherDelegatingAuthenticationManagerResolver.builder()
						.add(new RequestMatcherEntry<>(new AntPathRequestMatcher("/one/**"), this.one))
						.add(new RequestMatcherEntry<>(new AntPathRequestMatcher("/two/**"), this.two))
						.build();
		// @formatter:on
